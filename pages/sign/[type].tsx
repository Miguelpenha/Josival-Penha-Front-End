...
import { Container, Title, Button, ButtonLink, IconButton, TextButton } from '../../styles/pages/sign/type'
import onClick from '../../components/pages/sign/type/onClick'
...
function SignType() {
    ...
    return <>
        ...
        <Container>
            ...
            <Button onClick={() => onClick(type === 'admin' ? loginGoogleAdmin : loginGoogleTeacher)}>
