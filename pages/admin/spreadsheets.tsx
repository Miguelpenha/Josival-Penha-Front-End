...
import { Title, ContainerButtons, ButtonSpreadsheet } from '../../styles/pages/admin/spreadsheets'
...
function Spreadsheets() {
    ...
    return <>
        ...
        <ContainerDefault back="/admin">
            <Title>Planilhas</Title>
            <ContainerButtons>
                <ButtonSpreadsheet loading onClick={() => generateSpreadsheet('Professoras', 'Planilha de professoras.xlsx')} title="Professoras">
                ...
                <ButtonSpreadsheet loading onClick={() => generateSpreadsheet('Turmas', 'Planilha de turmas.xlsx')} title="Turmas">
                    <svg width="2.8em" height="2.8em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0z" fill="none"/>
                        <path d="M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 4h5v8l-2.5-1.5L6 12V4z"/>
                    </svg>
                </ButtonSpreadsheet>
                <ButtonSpreadsheet loading onClick={() => generateSpreadsheet('Alunos', 'Planilha de alunos.xlsx')} title="Alunos">
                    <svg width="2.8em" height="2.8em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0z" fill="none"/>
                ...
                <ButtonSpreadsheet loading onClick={() => generateSpreadsheet(filtersGeneralSpreadsheet.toString(), 'Planilha geral.xlsx')} title="Geral">
                    <svg width="2.8em" height="2.8em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
