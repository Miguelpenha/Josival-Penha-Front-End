...
function Spreadsheets() {
    ...
    return <>
        ...
        <Container>
            <Title>Planilhas</Title>
            <Button onClick={() => generateSpreadsheet('/teachers/export', 'Planilha de professoras.xlsx')} title="Professoras">
            ...
            <Button onClick={() => generateSpreadsheet('/classes/export', 'Planilha de turmas.xlsx')} title="Turmas">
                <svg width="2.8em" height="2.8em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path d="M0 0h24v24H0z" fill="none"/>
                    <path d="M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 4h5v8l-2.5-1.5L6 12V4z"/>
                </svg>
            </Button>
            <Button onClick={() => generateSpreadsheet('/students/export', 'Planilha de alunos.xlsx')} title="Alunos">
                <svg width="2.8em" height="2.8em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path d="M0 0h24v24H0z" fill="none"/>
                    <path d="M5 13.18v4L12 21l7-3.82v-4L12 17l-7-3.82zM12 3 1 9l11 6 9-4.91V17h2V9L12 3z"/>
                </svg>
            </Button>
            <Button onClick={() => generateSpreadsheet(`/export?filters=${filtersGeneralSpreadsheet.toString()}`, 'Planilha geral.xlsx')} title="Geral">
                <svg width="2.8em" height="2.8em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
